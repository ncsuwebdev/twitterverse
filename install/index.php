...
?>
<h2>Step 1:  Verify Zend Framework version <?php echo Tweets_Installer::ZF_REQUIREMENT; ?></h2>
<?php 
if ($zfCheck === true) {
    echo "Successfully found and verified Zend Framework version " . Tweets_Installer::ZF_REQUIREMENT;
} else {
    echo $zfCheck;
...
<?php if (!$twitterAppRegistration): ?>
    <ul>
        ...
        <li>Fill in this form with the values that correspond to your setup<br /><br />
            ...
            <b>Callback URL:</b> Enter the public url of your appliciation to /install/twitter_callback.php.  We think it is "<?php echo Tweets_Ncsu::getBaseUrl(); ?>/install/twitter_callback.php"<br />
...
<a href="<?php echo Tweets_Ncsu::getBaseUrl(); ?>"><h1>Visit Your Site</h1></a>
<br /><br /><br />
