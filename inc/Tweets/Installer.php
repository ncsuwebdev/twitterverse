...
class Tweets_Installer
{
    ...
    {
        $filepath = Tweets_Ncsu::getConfigFilePath();
    ...
    {
        $config = Tweets_Ncsu::getConfigFile();
    ...
    {
        $config = Tweets_Ncsu::getConfigFile(true);
        
        $config->site->url = $url;
        $config->feed->title = $feedTitle;
        $config->feed->author = $feedAuthor;
        
        $writer = new Zend_Config_Writer_Array(array('config' => $config, 'filename' => Tweets_Ncsu::getConfigFilePath()));
